...
public:
    ...
    void createFrame(char* image, double* hdImage, Particle* p, int step, Domain* box);
    void createFrame(char* image, double* hdImage, Particle* p, int* processNum, int numprocs, int step, Domain* box);
